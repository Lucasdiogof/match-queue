...
abstract interface class ProfileRemoteDataSource {
  Future<Map<String, dynamic>> listMyProfiles();

  /// Devolve o id da conta recem-criada -- ProfilesCubit.createProfile
  ...
  Future<void> deleteAvatarFile(String profileId);
  ...
  Future<Map<String, dynamic>> getProfileStats(String profileId);

  Future<List<Map<String, dynamic>>> listWeekendLeagueEvents();

  Future<Map<String, dynamic>> getWeekendLeagueProfileStats({
    required String profileId,
    required String eventId,
  });

  Future<Map<String, dynamic>> getRivalsProfileStats(String profileId);
}
...
class SupabaseProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  @override
  Future<Map<String, dynamic>> listMyProfiles() async {
  ...
  static const String _avatarBucket = 'fc-profile-avatars';
  ...
  @override
  Future<void> deleteAvatarFile(String profileId) async {
  ...
  @override
  Future<void> archiveProfile(String id) => _client.rpc<dynamic>(
    'archive_fc_account',
  ...
  @override
  Future<Map<String, dynamic>> getRivalsProfileStats(String profileId) async {
    final response = await _client.rpc<dynamic>(
