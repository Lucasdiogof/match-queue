...
class RivalsDetailPage extends StatefulWidget {
  const RivalsDetailPage({required this.profile, super.key});
...
class _RivalsDetailPageState extends State<RivalsDetailPage> {
  late Future<RivalsProfileStats> _future;
  ...
  void _load() {
    _future = getIt<ProfileRepository>().fetchRivalsProfileStats(
      widget.profile.id,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      body: FutureBuilder<RivalsProfileStats>(
        future: _future,
...
class _Body extends StatelessWidget {
  ...
  final RivalsProfileStats stats;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: <Widget>[
        _DivisionSection(profileId: profileId),
...
class _DivisionSection extends StatelessWidget {
  const _DivisionSection({required this.profileId});
