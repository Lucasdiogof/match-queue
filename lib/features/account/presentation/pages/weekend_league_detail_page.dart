...
import 'package:fifa_queue/features/account/presentation/widgets/weekend_league_week_picker.dart';
...
/// (unica fonte, ver Account.weekendLeagueRecord). Artilharia/assistencia
...
class _WeekendLeagueDetailPageState extends State<WeekendLeagueDetailPage> {
  ...
  void initState() {
    ...
    _event = widget.event;
    _eventsFuture = getIt<AccountRepository>().fetchWeekendLeagueEvents();
    _load();
  }
  ...
  void _load() {
    _future = getIt<AccountRepository>().fetchWeekendLeagueStats(_event.id);
  }
